...
from model import GatedAttentionMIL,Classification,LogisticRegression
import os
...
MLFLOW_EXPERIMENT   = "LogisticRegression_MIL_ADIS"
...
for outer_fold, (trainval_idx, test_idx) in enumerate(outer_cv.split(sc_input_numeric, y), start=1):
    ...
    def objective(trial):
        params = {
            "attn_dim":     trial.suggest_int("attn_dim", 64,128),
